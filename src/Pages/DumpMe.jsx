...
import { Mail, MessageCircle, Coffee, Heart, ArrowRight } from 'lucide-react';
...
const DumpMe = () => {
  ...
  const handleWhatsAppClick = () => {
    window.open('https://wa.me/916381353913', '_blank');
  };
        ...
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="p-8 md:p-12 space-y-8">
            ...
            <div className="space-y-4">
              <h3 className="text-xl font-serif text-[#2C2C2C] text-center mb-6">Get in Touch</h3>
              
              <button 
                onClick={handleMailClick}
                className="w-full flex items-center justify-between p-6 bg-[#F5F0E6] hover:bg-[#E4D8C4] transition-all duration-300 rounded-xl group"
              >
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center text-[#C5A059] group-hover:scale-110 transition-transform">
                    <Mail size={24} />
                  </div>
                  <div className="text-left">
                    <p className="text-xs uppercase tracking-[0.2em] text-[#8C7B5A]">Email Me</p>
                    <p className="text-sm font-medium text-[#2C2C2C]">aruvi2908@gmail.com</p>
                  </div>
                </div>
                <ArrowRight className="text-[#C5A059] group-hover:translate-x-1 transition-transform" size={20} />
              </button>
              ...
              >
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center text-[#25D366] group-hover:scale-110 transition-transform">
                    <MessageCircle size={24} />
                  </div>
                  <div className="text-left">
                    <p className="text-xs uppercase tracking-[0.2em] text-[#8C7B5A]">WhatsApp</p>
                    <p className="text-sm font-medium text-[#2C2C2C]">+91 6381353913</p>
                  </div>
                </div>
                <ArrowRight className="text-[#C5A059] group-hover:translate-x-1 transition-transform" size={20} />
              </button>
            ...
            <div className="border-t border-[#E4D8C4] pt-8 space-y-6">
              ...
              <div className="max-w-sm mx-auto space-y-4">
                <div className="bg-gradient-to-br from-[#C5A059] to-[#8C7B5A] rounded-xl p-8 text-center text-white shadow-lg">
                  ...
                  <p className="text-5xl font-serif mt-2">₹10</p>
                </div>

                <button 
                  onClick={handlePaymentClick}
                  className="w-full py-4 px-8 bg-[#2C2C2C] text-[#F5F0E6] uppercase tracking-[0.3em] text-sm font-semibold hover:bg-[#C5A059] transition-all duration-300 rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
                >
                  Pay Now
                </button>
              </div>
